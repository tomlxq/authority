...
INSERT INTO t_base_user (id,account,password,real_name,sex,email,mobile,office_phone,error_count,last_login_time,last_login_ip,remark) VALUES (1,'admin','0da1621eab956c886b122fdbe81f253a9ca57c6579b44713dc52e5d105127b204e1ecef3b25e3ce3','超级管理员',0,'admin@qq.com.cn','119','110',0,'2012-11-07 15:52:04','127.0.0.1','用户信息');
INSERT INTO t_base_user (id,account,password,real_name,sex,email,mobile,office_phone,error_count,last_login_time,last_login_ip,remark) VALUES (2,'test','f1f98e9b24dac713181b5dcc9d04da41d9d9342196e248fd61e0d82715d2040b8602cf0b5bd95342','测试用户',0,'test@qq.com','119','110',0,'2012-11-06 16:52:07',NULL,NULL);
